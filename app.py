...
# 2. THE IRONCLAD CSS (Kills Vertical Line Error & White Screen Bug)
st.markdown("""
    <style>
    /* Force Hardware Acceleration and kill the "White Screen" Loop */
    html, body, [data-testid="stAppViewContainer"] {
        background: #fbfbfd !important;
        opacity: 1 !important;
    }

    /* THE NUCLEAR OPTION FOR GRID: Force 4 columns on all iPhones */
