...
# --- 2. ENGINE (TRIPLE-CHECKED SYNTAX) ---
def call_google_ai(prompt):
    ...
    # PAYLOAD: Triple-checked for matching brackets
    payload = {
        "contents":
        }]
    }
...
st.caption("v9.2 | Syntax Verified Stable")

user_query = st.text_area("Enter Query:", placeholder="e.g. Solve for x: 2x + 10 = 20", height=100)
