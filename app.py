...
# --- 2. THE ENGINE (ZERO-LIBRARY REST PROTOCOL) ---
def call_google_ai(prompt):
    ...
    try:
        ...
        if response.status_code == 200:
            # Extracting the text path: candidates -> content -> parts -> text
...
st.caption("v10.0 | Syntax-Lock Stable")

user_query = st.text_area("Enter Math or Physics Query:", placeholder="e.g. Derive the quadratic formula step-by-step", height=150)
