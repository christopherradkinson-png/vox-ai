        ...
        "contents": [
            {
                "parts": [
                    {
                        "text": f"You are Verilogic Pro, an advanced scientific mathematics engine. Solve step-by-step using LaTeX formatting. Problem: {user_query}"
                    }
                ]
            }
        ]
...
user_input = st.text_area(
    ...
    placeholder="Example: Integrate x^2 from 0 to 5",
    height=150
)
...
with st.expander("📈 3D Graphing Engine"):
    ...
    if st.button("Generate Graph"):
        ...
        try:
            ...
            Z = eval(formula, {"__builtins__": {}}, safe_dict)
