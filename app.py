...
# --- 2. THE ENGINE (RESTORED & TRIPLE-CHECKED URL) ---
...
st.caption("v9.1 | Production REST Protocol")

user_query = st.text_area("Enter Query:", placeholder="e.g. 2+2", height=100)

if st.button("Execute Pro Logic"):
    if user_query:
        with st.spinner("Processing..."):
            # This is the "Show Your Work" feature baked into the prompt
            enhanced_prompt = f"Provide a step-by-step 'Show Your Work' explanation for: {user_query}. Use LaTeX for math."
...
# --- 4. 3D GRAPHING (RE-ADDED FOR COMPLETENESS) ---
